...
from scripts.conditions import medicine_cats_condition_fulfilled
...
class TestsMedCondition(unittest.TestCase):
    def test_fulfilled(self):
        ...
        all_cats = [cat1, med]
        self.assertTrue(medicine_cats_condition_fulfilled(all_cats, 15))
    ...
    def test_fulfilled_many_cats(self):
        ...
        self.assertTrue(medicine_cats_condition_fulfilled(all_cats, 2))
