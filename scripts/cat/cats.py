...
class Cat:
        ...
        for cat in Cat.all_cats.values():
            ...
            # it can fail to to minor grief. If they have a family relation, bypass the roll.
                ...
                minor_grief_messages = (
                    ...
                    "Bargains with the Starfallen, begging them to send r_c back",
                    "Sat all night at r_c's vigil",
                    "Will never forget r_c",
                    "Prays that r_c is safe with the Starfallen",
                    ...
                    "Lashes out at any dragon who checks on {PRONOUN/m_c/object} after r_c's death",
                    ...
                    "Wonders why the Starfallen had to take r_c so soon",
                ...
                if body:
                    minor_grief_messages += (
                        ...
                        "Hides a scale of r_c's under {PRONOUN/m_c/poss} nest to cling to",
                        "Can't stand the sight of r_c's body in camp",
                        "Hissed at anyone who got too close to r_c's body, refusing to let go",
                        "Spent a long time grooming r_c's scales for their vigil",
    ...
    def generate_lead_ceremony(self):
        ...
        if chosen_intro := choice(possible_intros):
            ...
            intro = "this should not appear, notify dev of this with what patrol text was happening before the error!"
        ...
        if chosen_outro:
            ...
            outro = "this should not appear, report to dev with description of what text appeared before this error!"
